...
<head>
    ...
    <script type="text/javascript">
        ...
        function checkUsername() {
            ...
            $("#usernameSpan").load("${pageContext.request.contextPath}/usr/customer/checkUsername.action?"+new Date().getTime(),{'username':username});
        }
        ...
        function checkUsername() {
            ...
            xhr.onreadystatechange = function () {
                if (xhr.status == 200 && xhr.readyState == 4) {
                    ...
                    document.getElementById("usernameSpan").innerHTML=responseText;
                }
            };
            // 3.打开连接
            xhr.open("GET","${pageContext.request.contextPath}/usr/customer/checkUsername.action?"+new Date().getTime()+"&username="+username, true);
            // 4.发送
            xhr.send(null);
        }
    ...
    <div class="span24">
        <div class="wrap">
            <div class="main clearfix">
                ...
                <form id="registerForm" action="${pageContext.request.contextPath}/usr/customer/register.action" method="post" novalidate="novalidate" onsubmit="return checkForm();">
                    <table>
                        <tbody>
                        <tr>
                            <th>
                            ...
                            <td>
                                ...
                                <span id="usernameSpan"><s:fielderror fieldName="username" /></span>
                            </td>
                        </tr>
                        <tr>
                            <th>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="password" id="confirmPassword" name="confirmPassword" class="text" maxlength="20" autocomplete="off" />
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <span><s:fielderror fieldName="telephone" /></span>
                            </td>
                        </tr>
                        <tr>
                            <th>
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="fieldSet">
                                        ...
                                        <label>
                                            <input type="radio" name="gender" value="2" checked="checked" />保密
                                        </label>
                                </span>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="fieldSet">
                                    <input type="hidden" id="areaId" name="region" />
                                    <select name="region_select" style="margin-right: 4px;">
                        ...
                        <tr>
                            ...
                            <td>
                                <div id="agreement" class="agreement" style="height: 200px;">
                                    ...
                                    <p>
                                        二、服务简介<br>
                                        本网站运用自己的操作系统通过国际互联网络为用户提供各项服务。用户必须:
                    ...
                    <div class="login">
                        ...
                        <dl>
                            ...
                            <dd>
                                立即登录即可体验在线购物！
                                <a href="${pageContext.request.contextPath}/usr/customer/goLogin.action">立即登录</a>
                            </dd>
                        </dl>
                    </div>
                </form>
